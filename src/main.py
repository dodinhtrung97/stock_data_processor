...
if __name__ == "__main__":
	a = headlineAnalyzer("Apple is acquired by Amazon", "apple", True)
	a.analyze()
	a = headlineAnalyzer("Amazon acquires Apple", "apple", True)
	a.analyze()
	a = headlineAnalyzer("Apple to be acquired by Amazon", "apple", True)
	a.analyze()
	a = headlineAnalyzer("Amazon to be acquired by Apple", "apple", True)
	a.analyze()
	a = headlineAnalyzer("Apple is acquiring Amazon", "apple", True)
	a.analyze()
	a = headlineAnalyzer("Apple acquired by Amazon", "apple", True)
	a.analyze()
